...
const form = useForm({
    ...
    cantidad: Number(props.productos.cantidad),
    ...
    stock: Number(props.productos.stock),
    precio: Number(props.productos.precio),
    ultima_entrada: Number(props.productos.ultima_entrada),
                                    ...
                                    <div class="">
                                        ...
                                        <div class="card text-sm mt-2 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2">
                                            ...
                                            <div>
                                                ...
                                                <InputNumber v-model="form.cantidad" inputId="integeronly" fluid :disabled="!$page.props.user.permissions.includes('Acciones Administrador')" />
                                        ...
                                        <div class="flex flex-col justify-center items-center gap-y-4">
                                            <div class="flex justify-center items-center flex-col gap-y-2.5">
                                                ...
                                                <FileInput name="foto" @change="(e) => onSelectFoto2(e, 'foto')" class="sm:text-sm text-xs" />
                                            </div>
                                            <span v-if="form.errors.imagen_producto" class="text-red-500 text-sm">{{ form.errors.imagen_producto }}</span>
                                            <div class="flex flex-col md:flex-row justify-center items-center gap-y-4 gap-x-6">
