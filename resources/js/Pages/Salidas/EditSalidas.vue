...
onMounted(() => {
    ...
    const salida_id = localStorage.getItem('salida_id');
    const salida_producto = localStorage.getItem('salida_producto');
    
    if (salida_id && salida_producto) {
        form.producto_id = salida_id;
        form.name = salida_producto;
        searchTerm.value = salida_producto;
    } else {
