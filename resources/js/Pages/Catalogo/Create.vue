                                ...
                                <div class="flex flex-col items-start">
                                    ...
                                    <div class="flex w-full">
                                        <select id="tbcategoria" v-model="form.tbcategoria_id" required
                                            ...
                                            class="mt-1 focus:ring-indigo-500 dark:text-black focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-l-lg">
            ...
            <div class="p-4 uppercase">
                ...
                <div class="p-1">
                    ...
                    <div class="w-full mt-4">
                        ...
                        class="mt-1 focus:ring-indigo-500 dark:text-black focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
