            ...
            response.forEach(function(hservicio) {
                ...
                if (hservicio.instrumento == "1") {
                    ...
                    <tr data-hservicio='${hservicioJson}' class="bg-white text-black border-b text-xs border-gray-300 dark:bg-gray-700 dark:text-white hover:text-white dark:hover:bg-gray-900 hover:bg-gray-500 cursor-pointer">
                        ...
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${ hservicio.hmarca_id ? hservicio.hmarca_id : 's/n' }</td>
...
function fn_limpiarCamposImag() {
    imageInformeCli1.value = '';
    imageInformeCli2.value = '';
    imagePreviewsInformesCli.value[0] = '';
    imagePreviewsInformesCli.value[1] = '';
    document.getElementById('fotoInforme1').value = '';
    document.getElementById('fotoInforme2').value = '';
}
...
<template>
    <AppLayout title="Informes Tecnicos">
        <template #header>
            <h1 class="font-semibold text-base uppercase text-gray-800 leading-tight dark:text-white" id="h1InformesTecnicos">3.- Informes Tecnicos</h1>
            <h1 class="font-semibold text-base uppercase text-gray-800 leading-tight dark:text-white hidden" id="h1DiagnosticodeInforme">N° INFORME: <span id="nroInformeTecnico" class="mx-4"></span></h1>
        ...
        <div id="divTablitaHojasdeServicio" class="py-2 md:py-4 min-h-[calc(100vh-185px)] overflow-auto hidden">
            <div class="h-full mx-auto px-4 sm:px-6 lg:px-8">
                <div class="p-6 bg-white border-gray-600 rounded-lg dark:bg-gray-800">
                    ...
                    <div class="py-2 flex flex-col gap-y-2.5">
                        <span class="font-bold">DIAGNOSTICO TECNICO</span>
                        <div class="flex items-center font-bold p-4 border py-1 border-green-600 rounded bg-green-600">
                            <p class="py-3.5 sm:text-base text-xs text-white font-bold mx-4">CLIENTE: <span id="razonSocialTexto"></span></p>
                            ...
                            <div>
                                <div class="grid grid-cols-1 md:grid-cols-6">
                                    ...
                                    <div class="md:col-end-7 md:col-span-2">
                                        ...
                                        <select v-model="form.instrumento" disabled id="instrumento" class="mt-1 dark:text-black focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                ...
                                <div class="grid grid-cols-1 gap-y-3 sm:grid-cols-2 lg:grid-cols-4 sm:gap-x-6 mb-2">
                                    <div id="divMarca">
                                        ...
                                        <TextInput v-model="form.hmarca_id" type="text" id="hmarca_id"
                                            disabled class="mt-1 dark:text-black focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                    </div>
                                    <div id="divModelo">
                    ...
                    <div class="flex justify-end">
                        <button class="text-white bg-blue-600 flex justify-center items-center text-center md:gap-2 gap-4 font-bold hover:bg-blue-700 uppercase text-sm py-2 px-6 rounded md:w-min whitespace-nowrap w-full" id="btnListarHojasdeServicio">
                            <i class="fa-solid fa-arrow-left"></i>Informes Tecnicos
                        </button>
                    </div>
                </div>
            </div>
