...
const editHojaServicio = (hservicio) => {
    ...
    imagePreview1.value = hservicio.foto
        ? "/hservicio_img/" + hservicio.foto
        : null;
    imagePreview2.value = hservicio.foto2
        ? "/hservicio_img/" + hservicio.foto2
        : null;
    imagePreview3.value = hservicio.foto3
        ? "/hservicio_img/" + hservicio.foto3
        : null;
...
const submitForm = () => {
    ...
    if (!form.id) {
            ...
            success: function (response) {
                if (response) {
                    ...
                    form.post(route("hservicios.store"), {
                        onSuccess: () => {
                            show_alerta(
                                "La hoja de servicio se ha registrado correctamente.",
                                "success"
                            );
                        ...
                        onError: (errors) => {
                            if (errors.response && errors.response.status) {
                                show_alerta(
                                    "Ha ocurrido un error al registrar el producto. Por favor, inténtalo de nuevo.",
                                    "error"
                                );
                                console.error(
                                    "Error HTTP:",
        ...
        form.put(route("hservicios.update", form.id), {
            onSuccess: () => {
                show_alerta(
                    "La hoja de servicio se ha actualizado correctamente.",
                    "success"
                );
                form.id = null;
...
const onKeydown = (event) => {
    if (filteredClientes.value.length > 0) {
        if (event.key === "ArrowDown") {
            ...
            selectedIndex.value =
                (selectedIndex.value + 1) % filteredClientes.value.length;
        } else if (event.key === "ArrowUp") {
            event.preventDefault();
            selectedIndex.value =
                (selectedIndex.value - 1 + filteredClientes.value.length) %
                filteredClientes.value.length;
...
function obtenerDatosTiempoReal(fecha) {
    $.ajax({
        ...
        success: function (response) {
            ...
            response.forEach(function (hservicio) {
                ...
                if (hservicio.instrumento == "1") {
                    ...
                    <tr data-hservicio='${hservicioJson}' class="bg-white text-black border-b text-xs border-gray-300 dark:bg-gray-700 dark:text-white hover:text-white dark:hover:bg-gray-900 hover:bg-gray-500 cursor-pointer">
                        ...
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-4 text-center">${
                            hservicio.hmarca_id ? hservicio.hmarca_id : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.modelo ? hservicio.modelo : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.capacidad ? hservicio.capacidad : "s/n"
                        } ${
                        hservicio.medida_capacidad
                            ? hservicio.medida_capacidad
                            : "s/n"
                    }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.serie ? hservicio.serie : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.division ? hservicio.division : "s/n"
                        } ${
                        hservicio.medida_division
                            ? hservicio.medida_division
                            : "s/n"
                    }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.plataforma ? hservicio.plataforma : "s/n"
                        } ${
                        hservicio.medida_plataforma
                            ? hservicio.medida_plataforma
                            : "s/n"
                    }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.requiere ? hservicio.requiere : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.tecnico ? hservicio.tecnico : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.encargado ? hservicio.encargado : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center capitalize">${
                            formatDate(hservicio.fecha)
                                ? hservicio.fecha
                                : "s/n"
                        }</td>
                    </tr>
                    `;
                    $("#tbodyContenedorHojasServiciosBalanzas").append(
                        nuevaFila
                    );
                    ...
                    <tr data-hservicio='${hservicioJson}' class="bg-white text-black border-b text-xs border-gray-300 dark:bg-gray-700 dark:text-white hover:text-white dark:hover:bg-gray-900 hover:bg-gray-500 cursor-pointer">
                        ...
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.rango ? hservicio.rango : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                    ...
                    `;
                    $("#tbodyContenedorHojasServiciosTermometros").append(
                        nuevaFila
                    );
                    ...
                    <tr data-hservicio='${hservicioJson}' class="bg-white text-black border-b text-xs border-gray-300 dark:bg-gray-700 dark:text-white hover:text-white dark:hover:bg-gray-900 hover:bg-gray-500 cursor-pointer">
                        ...
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.codigo ? hservicio.codigo : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.capacidad ? hservicio.capacidad : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.material ? hservicio.material : "s/n"
                        }</td>
                        <td class="px-4 border-b-2 border-r-[0.1px] dark:border-gray-500 dark:border-b-gray-400 py-3 text-center">${
                            hservicio.requiere ? hservicio.requiere : "s/n"
                        }</td>
            ...
            $(
                "#tbodyContenedorHojasServiciosBalanzas, #tbodyContenedorHojasServiciosTermometros, #tbodyContenedorHojasServiciosPesas"
            ).on("dblclick", "tr", function () {
                console.log($(this).attr("data-hservicio"));
                ...
                if (response.length > 0) {
                    response.forEach(function (hservicio) {
                        ...
                        if (hservicio.instrumento == "1") {
                            ...
                            `;
                            $(
                                "#tbodyContenedorHojasServiciosTermometros"
                            ).append(nuevaFila);
                        } else if (hservicio.instrumento == "3") {
                            // Para Pesas
                            nuevaFila = `
                            ...
                            `;
                            $("#tbodyContenedorHojasServiciosPesas").append(
                                nuevaFila
                            );
                        }
                    });
                    ...
                    show_alerta(
                        "No se encontraron registros en esta fecha.",
                        "error"
                    );
                }
...
function previsualizarpdf() {
    ...
    const instrumento =
        document.getElementById("instrumento").options[
            document.getElementById("instrumento").selectedIndex
        ].text;
    ...
    const medida_division =
        document.getElementById("medida_division").options[
            document.getElementById("medida_division").selectedIndex
        ].text;
    const capacidad = document.getElementById("capacidad").value;
    const medida_capacidad =
        document.getElementById("medida_capacidad").options[
            document.getElementById("medida_capacidad").selectedIndex
        ].text;
    ...
    function fn_dibujarDatosdelEquipo() {
        if (instrumento == "Balanzas") {
            ...
            doc.autoTable({
                body: [["MARCA", hmarca_id, "MODELO", modelo]],
                rowPageBreak: "avoid",
                theme: "grid",
                styles: {
                    fontSize: 8,
            ...
            doc.autoTable({
                body: [["REQUIERE", requiere, "PERSONAL ENCARGADO", encargado]],
                rowPageBreak: "avoid",
                theme: "grid",
                styles: {
                    fontSize: 8,
            ...
            doc.autoTable({
                body: [[`DATOS DEL EQUIPO : TERMOMETRO`]],
                rowPageBreak: "avoid",
                theme: "grid",
                styles: {
                    fontSize: 8,
            ...
            doc.autoTable({
                body: [["CODIGO", codigo, "MATERIAL", material]],
                rowPageBreak: "avoid",
                theme: "grid",
                styles: {
                    fontSize: 8,
    ...
    function fn_dibujarDiagnosticoTecnico() {
        doc.autoTable({
            body: [
                [
                    {
                        content: "DIAGNOSTICO DEL TECNICO :",
                        styles: {
                            halign: "left",
                            fontStyle: "bold",
                            textColor: [0, 0, 0],
        ...
        doc.line(
            10.1,
            lineYPosition,
            doc.internal.pageSize.width - 10.1,
            lineYPosition
        );
    }
        ...
        <div class="py-2 md:py-4 min-h-[calc(100vh-185px)] overflow-auto">
            <div class="h-full mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div class="h-full mx-auto px-4 sm:px-6 lg:px-8">
                        <div
                            class="md:p-1 flex justify-center items-center text-center w-full"
                        >
                            <div
                                class="font-semibold text-base uppercase text-white md:w-80 w-full bg-green-600 rounded-md p-2 leading-tight dark:text-white"
                            >
                                N° de Informe : {{ informeNumero }}
                            </div>
                        </div>
                        <form @submit.prevent="submitForm">
                            <div
                                class="grid grid-cols-1 sm:grid-cols-3 md:py-0 py-2"
                            >
                                <div class="w-full -mb-2">
                                    <InputLabel for="cliente_id" class="text-xs"
                                        >Cliente</InputLabel
                                    >
                                    <div class="relative">
                                        <TextInput
                                        ...
                                        >
                                            <div
                                                ...
                                                :key="cliente.id"
                                                :class="[
                                                    'text-gray-800 text-sm dark:text-white font-medium cursor-pointer overflow-hidden whitespace-nowrap text-ellipsis dark:hover:bg-gray-700 hover:bg-gray-200 option p-2',
                                                    {
                                ...
                                <div
                                    class="col-span-1 col-start-0 col-end-0 sm:col-start-3 sm:col-end-4 mb-2"
                                >
                                    <InputLabel
                                        for="instrumento"
                            ...
                            <div
                                class="grid grid-cols-1 gap-y-3 sm:grid-cols-2 lg:grid-cols-4 sm:gap-x-6 mb-3"
                            >
                                <div id="divMarca">
                                ...
                                <div id="divMedidaBastago" class="hidden">
                                    ...
                                    <div class="flex">
                                        <TextPrueba
                                            ...
                                            type="text"
                                            id="medida_bastago"
                                            class="mt-1 dark:text-black focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-l-lg"
                                        />
                                        <InputError
                                            :message="
                                        ...
                                        <input
                                            ...
                                            class="dark:text-gray-900 mt-1 text-center focus:ring-indigo-500 focus:border-indigo-500 block w-16 cursor-pointer tracking-widest shadow-sm sm:text-sm border-gray-300 rounded-r-lg"
                                        />
                                    </div>
                                </div>
                                <div id="divDivision">
                                    ...
                                    <div class="flex justify-center">
                                        ...
                                        <select
                                            ...
                                            required
                                            class="mt-1 dark:text-black focus:ring-indigo-500 focus:border-indigo-500 block w-24 cursor-pointer tracking-widest shadow-sm sm:text-sm border-gray-300 rounded-r-lg"
                                        >
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        type="date"
                                        id="fecha"
                                        class="mt-1 dark:text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    />
                                    <InputError
                            ...
                            >
                                <div>
                                    <InputLabel
                                        for="diagnostico"
                                        value="diagnostico tecnico (ESTADO ACTUAL DEL INSTRUMENTO)"
                                    />
                                    <textarea
                                        id="diagnostico"
                            ...
                            <div class="d-flex mt-4">
                                ...
                                >
                                    <ButtonResponsive
                                        v-if="!isEditing"
                                        id="btnLimpiarImagenesFrm"
                                        class="uppercase text-xs bg-red-600 hover:bg-red-700"
                                        >Limpiar Campos de
                                        Imagenes</ButtonResponsive
                                    >
                                    <ButtonResponsive
                                        v-if="isEditing"
                                        id="crearNuevaHojaServicio"
                                        class="uppercase text-xs bg-red-600 hover:bg-red-700"
                                        >Nuevo Informe Tecnico</ButtonResponsive
                                    >
                                    <button
                                        @click.prevent="previsualizarpdf"
                                        class="inline-block bg-green-700 text-white font-bold py-2 px-4 rounded hover:bg-green-800 md:w-min whitespace-nowrap w-full text-center uppercase text-xs"
                                    >
                                        Previsualizar Informe Tecnico
                                    </button>
                                    <ButtonResponsive
                                        id="btnguardarHojaServicio"
                                        v-if="!isEditing"
                                        class="uppercase text-xs"
                                        >Guadar Informe
                                        Tecnico</ButtonResponsive
                                    >
                                    <button
                                        id="loading-button"
                                        disabled
                                    ...
                                    >
                                        <svg
                                            aria-hidden="true"
                                            role="status"
                                            class="inline w-4 mt-[3px] h-4 me-3 text-white animate-spin"
                                            viewBox="0 0 100 101"
                                            fill="none"
                        ...
                        <div class="py-4 flex flex-col gap-4">
                            <div
                                class="relative overflow-x-auto scroll-dataTableLEO shadow-lg sm:rounded-lg shadow-gray-400 dark:shadow-gray-800"
                            >
                                <table
                                    id="construirTablaBalanzas"
                                    class="w-full hidden text-sm text-left rtl:text-right text-gray-500 dark:text-gray-900"
                                >
                                    <caption
                                        class="bg-gray-500 dark:bg-gray-700 p-2 w-full rounded-lt-lg border-b-2 text-sm font-bold text-gray-100"
                                    >
                                        Balanzas
                                    </caption>
                                    <thead
                                    ...
                                    >
                                        <tr>
                                            <th
                                                scope="col"
                                                class="px-1 py-3 text-center dark:border-white border-b-2"
                                            >
                                                N°
                                            </th>
                                            <th
                                    ...
                                    <tbody
                                        id="tbodyContenedorHojasServiciosBalanzas"
                                    >
                                        <tr
                                            class="rounded-lg border-2 dark:border-gray-700 dark:text-gray-200"
                                        >
                                            <td
                                                colspan="10"
                                                class="text-center"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <tbody
                                        id="tbodyContenedorHojasServiciosTermometros"
                                    >
                                        <tr
                                            class="rounded-lg border-2 dark:border-gray-700 dark:text-gray-200"
                                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <tbody
                                        id="tbodyContenedorHojasServiciosPesas"
                                    >
                                        <tr
                                            class="rounded-lg border-2 dark:border-gray-700 dark:text-gray-200"
                                        >
